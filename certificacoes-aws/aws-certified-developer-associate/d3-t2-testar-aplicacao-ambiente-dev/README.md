...
# Tarefa 2: Testar Aplicativos em Ambientes de Desenvolvimento (d3-t2-testar-aplicacao-ambiente-dev)
...
- [ ] Domínio de Conteúdo 3: Implantação
  - [ ] Tarefa 2: Testar Aplicativos em Ambientes de Desenvolvimento
    - [ ] Habilidade: Testar código implantado usando serviços e ferramentas da AWS
    - [ ] Habilidade: Escrever testes de integração e simular APIs para dependências externas
    - [ ] Habilidade: Testar aplicações usando endpoints de desenvolvimento (por exemplo, configurando estágios no Amazon API Gateway)
    - [ ] Habilidade: Implantar atualizações da pilha de aplicações em ambientes existentes (por exemplo, implantar um modelo do AWS SAM em um ambiente de teste diferente)
    - [ ] Habilidade: Testar aplicações orientadas a eventos
