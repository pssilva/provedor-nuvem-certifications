# Tarefa 2: Projetar e implementar soluções de registro em log (d1-t2-projetar-implementar-solucoes-registro-log)
...
- [ ] Domínio do conteúdo 1: Detecção
  - Representa 16% do conteúdo pontuado
    - [ ] Tarefa 2: Projetar e implementar soluções de registro em log.
