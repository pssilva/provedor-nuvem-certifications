...
# Tarefa 2: Implementar uma estratégia de implantação segura e consistente para recursos de nuvem (d6-t2-implantacao-segura-recursos-nuvem)
...
- [ ] Domínio do conteúdo 6: Fundamentos de segurança e governança
  - Representa 14% do conteúdo pontuado
    - [ ] Tarefa 2: Implementar uma estratégia de implantação segura e consistente para recursos de nuvem.
