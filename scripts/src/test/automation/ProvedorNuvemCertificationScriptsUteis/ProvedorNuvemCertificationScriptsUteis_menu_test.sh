#!/bin/bash
# ==============================================================
# Filename: ProvedorNuvemCertificationScriptsUteis_menu_test.sh

# Auth: Paulo Sérgio da Silva <pss1suporte@gmail.com>
# Describe: Script para testa a função ProvedorNuvemCertificationScriptsUteis.menu
# version: 1.0
# license: MIT License
#
# ==============================================================
...
# ==============================================================
export NAME_PROJECT="ProvedorNuvemCertificationScriptsUteis"
...
ProvedorNuvemCertificationScriptsUteis.menu
#ProvedorNuvemCertificationScriptsUteis.menu "$PATH_WORK" "$GROUP_ID" "$ARTIFACT_ID"
...
#
# sudo chmod +x ${HOME}/projetos/acmecorp-erp-hyperledger-fabric/scripts/src/test/automation/ProvedorNuvemCertificationScriptsUteis/ProvedorNuvemCertificationScriptsUteis_menu_test.sh
# source ${HOME}/projetos/acmecorp-erp-hyperledger-fabric/scripts/src/test/automation/ProvedorNuvemCertificationScriptsUteis/ProvedorNuvemCertificationScriptsUteis_menu_test.sh
#
########################################################
