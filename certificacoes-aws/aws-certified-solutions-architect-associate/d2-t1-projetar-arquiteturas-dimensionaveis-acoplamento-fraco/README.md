...
# Tarefa 1: Projetar arquiteturas dimensionáveis e com acoplamento fraco (d2-t1-projetar-arquiteturas-dimensionaveis-acoplamento-fraco)
...
- [ ] Domínio do conteúdo 2: Criação de arquiteturas resilientes
  - [ ] Tarefa 1: Projetar arquiteturas dimensionáveis e com acoplamento fraco
    - Conhecimento sobre:
      - [ ] Criação e gerenciamento de APIs
        - por exemplo, Amazon API Gateway, API REST
      - [ ] Serviços gerenciados da AWS com casos de uso apropriados
        - por exemplo, AWS Transfer Family, Amazon SQS, AWS Secrets Manager
      - [ ] Estratégias de armazenamento em cache
      - [ ] Princípios de design para microsserviços
        - por exemplo, workloads stateless em comparação com workloads stateful
      - [ ] Arquiteturas orientadas por eventos
      - [ ] Scaling horizontal e vertical
      - [ ] Como usar adequadamente aceleradoras de borda
        - por exemplo, rede de entrega de conteúdo [CDN]
      - [ ] Como migrar aplicações para contêineres
      - [ ] Conceitos de balanceamento de carga
        - por exemplo, Application Load Balancer [ALB]
      - [ ] Arquiteturas multicamadas
      - [ ] Conceitos de enfileiramento e sistema de mensagens
        - por exemplo, publicar/assinar
      - [ ] Tecnologias e padrões sem servidor
        - por exemplo, AWS Fargate, AWS Lambda
      - [ ] Tipos de armazenamento com características associadas
        - por exemplo, objeto, arquivo, bloco
      - [ ] A orquestração de contêineres
        - por exemplo, Amazon ECS, Amazon EKS
    ...
    - Habilidades em:
      ...
      - [ ] Determinar quando usar padrões e tecnologias sem servidor
      - [ ] Recomendar tecnologias apropriadas de computação, armazenamento, redes e banco de dados com base em requisitos
      - [ ] Usar serviços da AWS com propósito específico para workloads
