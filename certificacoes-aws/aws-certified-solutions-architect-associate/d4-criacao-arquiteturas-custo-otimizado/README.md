...
# Domínio do conteúdo 4: Criação de arquiteturas com custo otimizado (d4-criacao-arquiteturas-custo-otimizado)
...
- [ ] Domínio do conteúdo 4: Criação de arquiteturas com custo otimizado
  - [ ] Tarefa 1: Projetar soluções de armazenamento econômicas
  - [ ] Tarefa 2: Projetar soluções de computação econômicas
  - [ ] Tarefa 3: Projetar soluções de banco de dados econômicas
  - [ ] Tarefa 4: Projetar arquiteturas de rede com custo otimizado