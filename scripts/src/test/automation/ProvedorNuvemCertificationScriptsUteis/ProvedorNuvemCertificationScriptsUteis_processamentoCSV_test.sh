#!/bin/bash
# ==============================================================
# Filename: ProvedorNuvemCertificationScriptsUteis_processamentoCSV_test.sh

# Auth: Paulo Sérgio da Silva <pss1suporte@gmail.com>
# Describe: Script para testa a função ProvedorNuvemCertificationScriptsUteis.processamentoCSV
# version: 1.0
# license: MIT License
#
# ==============================================================
...
#
# sudo chmod +x ${HOME}/projetos/provedor-nuvem-certifications/scripts/src/test/automation/ProvedorNuvemCertificationScriptsUteis/ProvedorNuvemCertificationScriptsUteis_processamentoCSV_test.sh
# source ${HOME}/projetos/provedor-nuvem-certifications/scripts/src/test/automation/ProvedorNuvemCertificationScriptsUteis/ProvedorNuvemCertificationScriptsUteis_processamentoCSV_test.sh
#
########################################################
