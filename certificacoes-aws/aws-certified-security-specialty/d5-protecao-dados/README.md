...
# Domínio do conteúdo 5: Proteção de dados (d1-protecao-dados)
...
- [ ] Domínio do conteúdo 5: Proteção de dados
  - Representa 18% do conteúdo pontuado
    - [ ] Tarefa 1: Projetar e implementar controles para dados em trânsito.
    - [ ] Tarefa 2: Projetar e implementar controles para dados em repouso.
    - [ ] Tarefa 3: Projetar e implementar controles para proteger dados confidenciais, segredos e materiais de chaves criptográficas.
