...
# Tarefa 1: Projetar e implementar soluções de monitoramento e alertas para uma organização ou conta da AWS (d1-t1-projetar-implementar-solucoes-monitoramento-alertas)
...
- [ ] Domínio do conteúdo 1: Detecção
  - Representa 16% do conteúdo pontuado
    - [ ] Tarefa 1: Projetar e implementar soluções de monitoramento e alertas para uma organização ou conta da AWS.
