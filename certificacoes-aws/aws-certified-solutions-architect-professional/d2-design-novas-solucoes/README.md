...
# Domínio do conteúdo 2: Design de novas soluções (d2-design-novas-solucoes)
...
- [ ] Domínio do conteúdo 2: Design de novas soluções
  - peso no exame: 29% da pontuação do conteúdo
    - [ ] Tarefa 1: Criar uma estratégia de implantação para atender aos requisitos de negócios
    - [ ] Tarefa 2: Projetar uma solução para garantir a continuidade de negócio
    - [ ] Tarefa 3: Determinar os controles de segurança com base nos requisitos
    - [ ] Tarefa 4: Criar uma estratégia para atender aos requisitos de confiabilidade
    - [ ] Tarefa 5: Projetar uma solução para atender aos objetivos de desempenho
    - [ ] Tarefa 6: Determinar uma estratégia de otimização de custos para atender às metas e aos objetivos da solução