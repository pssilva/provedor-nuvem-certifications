...
- [ ] Domínio de Conteúdo 4: Solução de Problemas e Otimização
  - [ ] Tarefa 1: Auxiliar na análise da causa raiz
    ...
    - [ ] Interpretar métricas, logs e rastreamentos de aplicativos
    - [ ] Consultar logs para encontrar dados relevantes
    - [ ] Implementar métricas personalizadas (por exemplo, formato de métrica incorporada do Amazon CloudWatch [EMF])
    - [ ] Analisar a integridade do aplicativo usando painéis e insights
    - [ ] Solucionar problemas de falhas de implantação usando logs de saída do serviço
    - [ ] Depurar problemas de integração de serviços em aplicativos
