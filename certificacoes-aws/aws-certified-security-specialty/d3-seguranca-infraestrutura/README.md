...
# Domínio do conteúdo 3: Segurança de infraestrutura (d3-seguranca-infraestrutura)
...
Tomando como base os tópicos da Certificação [AWS Certified Security - Specialty (SCS-C03) (aws-certified-security-specialty)](https://aws.amazon.com/pt/certification/certified-security-specialty/?ch=sec&sec=rmg&d=1). 
...
- [ ] Domínio do conteúdo 3: Segurança de infraestrutura
  - Representa 18% do conteúdo pontuado
    - [ ] Tarefa 1: Projetar, implementar e solucionar problemas de controles de segurança para serviços de borda da rede.
    - [ ] Tarefa 2: Projetar, implementar e solucionar problemas de controles de segurança para workloads de computação.
    - [ ] Tarefa 3: Projetar e solucionar problemas de controles de segurança de rede.
