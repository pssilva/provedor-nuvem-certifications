...
# Domínio do conteúdo 4: Aceleração da migração e da modernização de workloads (d4-aceleracao-migracao-modernizacao-workloads)
...
- [ ] Domínio do conteúdo 4: Aceleração da migração e da modernização de workloads
  - peso no exame: 20% da pontuação do conteúdo
    - [ ] Tarefa 1: Selecionar workloads e processos existentes para uma possível migração
    - [ ] Tarefa 2: Determinar a abordagem de migração ideal para workloads existentes
    - [ ] Tarefa 3: Determinar uma nova arquitetura para workloads existentes
    - [ ] Tarefa 4: Determinar oportunidades de modernização e aprimoramentos
