...
# Tarefa 3: Solucionar problemas relacionados a soluções de registro em log, alertas e monitoramento da segurança (d1-t3-solucionar-problemas-registro-alerta-monitoramento)
...
- [ ] Domínio do conteúdo 1: Detecção
  - Representa 16% do conteúdo pontuado
    - [ ] Tarefa 3: Solucionar problemas relacionados a soluções de registro em log, alertas e monitoramento da segurança.
