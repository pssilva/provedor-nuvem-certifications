...
# Tarefa 1: Projetar, implementar e solucionar problemas de estratégias de autenticação (d4-t1-solucionar-problemas-estrategias-autenticacao)
...
- [ ] Domínio do conteúdo 4: Gerenciamento de identidade e acesso
  - Representa 20% do conteúdo pontuado
    - [ ] Tarefa 1: Projetar, implementar e solucionar problemas de estratégias de autenticação.
