...
# Tarefa 1: Desenvolver uma estratégia para implantar e gerenciar de maneira centralizada as contas da AWS (d6-t1-gerenciamento-centralizado-aws)
...
- [ ] Domínio do conteúdo 6: Fundamentos de segurança e governança
  - Representa 14% do conteúdo pontuado
    - [ ] Tarefa 1: Desenvolver uma estratégia para implantar e gerenciar de maneira centralizada as contas da AWS.
