...
# Tarefa 2: Projetar, implementar e solucionar problemas de estratégias de autorização (d4-t2-solucionar-problemas-estrategias-autorizacao)
...
- [ ] Domínio do conteúdo 4: Gerenciamento de identidade e acesso
  - Representa 20% do conteúdo pontuado
    - [ ] Tarefa 2: Projetar, implementar e solucionar problemas de estratégias de autorização.
